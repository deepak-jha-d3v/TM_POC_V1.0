...
RULE_DESCRIPTIONS = {
    "R01_STRUCTURING": "Multiple deposits just under the $10,000 reporting threshold within a few days -- a classic structuring pattern used to avoid CTR filing.",
    "R02_PROFILE_UPDATE_BEFORE_LARGE_TXN": "Customer changed profile details (address, contact, employer) shortly before an unusually large transaction.",
    "R03_UNUSUAL_SPENDING_PATTERN": "A transaction amount that is a statistical outlier compared to the customer's own historical spending average.",
    "R04_LOW_BUYER_DIVERSITY": "Crypto sales concentrated among a very small number of counterparties, suggesting a closed or collusive trading ring.",
    "R05_DISPROPORTIONATE_FLOW_THROUGH": "Funds pass through the account in a short window with little balance retained -- consistent with a pass-through/mule account.",
    "R06_HIGH_RISK_COUNTRIES": "Transactions involving counterparties in jurisdictions flagged as high-risk for money laundering or sanctions exposure.",
    "R07_PRIVATE_WALLET_WITHDRAWAL": "Crypto proceeds withdrawn immediately to a private (non-custodial) wallet rather than another exchange, reducing traceability.",
    "R08_CASH_TRANSACTIONS": "Cash deposits or withdrawals that are large or frequent relative to the customer's expected profile.",
    "R09_DORMANT_ACCOUNTS": "An account with little to no activity suddenly used for a significant transaction.",
    "R10_FREQUENT_CONVERSIONS": "Repeated rapid conversions between fiat and crypto, a pattern often used to obscure the source of funds.",
    "R11_ROUND_TRIPPING": "Funds sent out and returned to the same customer/related party in a short window with no clear economic purpose.",
    "R12_MULTI_ACCOUNT_FRAGMENTATION": "Similar near-threshold transactions split across multiple accounts held by the same customer.",
}
